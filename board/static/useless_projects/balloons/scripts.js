try {
    ...
    */
    ...
    //Composite.scale(ragdoll, 1, 1, ragdoll.position);
    ...
    Body.setPosition(balloon_cart, { x: window.innerWidth / 2, y: window.innerHeight * 0.9 });
    ...
    if (ratio > 1) {
        var pull_down_w1 = window.innerWidth * 0.30;
        var pull_down_h1 = window.innerHeight * 0.03;

        var pull_down_w2 = window.innerWidth * 0.30;
    ...
    var balloon_list = [];
    for (let i = 0; i < 10; i++) {
        var tmp1 = create_balloons(window.innerWidth / 2, window.innerHeight * 0.6, length_rope, -100, -100, balloon_cart);
        var tmp2 = create_balloons(window.innerWidth / 2, window.innerHeight * 0.6, length_rope, 100, -100, balloon_cart);
    ...
    if (ratio > 1) {
        var force_up = 0.00020;
    } else {
        var force_up = 0.00010;
    }
    var gravity = false;
