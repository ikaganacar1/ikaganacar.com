...
def create_aidat_makbuzu(
    daire_no, ay_yil, tarih, makbuz_no, tutar, yazi_ile, alan_ad, veren_ad, masraflar_list
):

    c = canvas.Canvas("makbuz.pdf", pagesize=landscape(A5))
    ...
    y_position -= 30
    c.rect(x_position + 135, y_position, 60, 20)
